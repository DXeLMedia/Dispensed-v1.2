...
const GigManagementCard: React.FC<GigManagementCardProps> = ({ gig, onRateClick, onEditClick }) => {
    ...
    const cardContent = (
         <div className="bg-[var(--surface-1)] border border-[var(--border)] rounded-lg overflow-hidden transition-colors duration-200 hover:border-[var(--accent)] animate-pop-in">
            {gig.flyerUrl && (
